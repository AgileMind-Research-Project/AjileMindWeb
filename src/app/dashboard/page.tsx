    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {/* View All Reports - For All Users */}
          <button
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">All AI reports</p>
              </div>
            </div>
          </button>

          {/* Upload Reports - For All Users */}
          <button
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">For RAG chatbot</p>
              </div>
            </div>
          </button>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Chat with reports</p>
              </div>
            </div>
          </button>

          {/* Upload Transcript - For All Users */}
          <button
